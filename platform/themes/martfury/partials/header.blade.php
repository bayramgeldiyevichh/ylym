            ...
            <div class="header__top">
                <div class="ps-container">
                    <div class="header__left">
                        ...
                        </div><a class="ps-logo" href="{{ route('public.index') }}"><img src="{{ RvMedia::getImageUrl(theme_option('logo')) }}" alt="{{ theme_option('site_title') }}" height="80"></a>
                    </div>
                                ...
                                <div class="ps-block--user-header">
                                    ...
                                    <div class="ps-block__right">
                                        @if (auth('customer')->check())
                                            <a href="{{ route('customer.overview') }}" style="line-height: 18px;" class="customer-name">{{ auth('customer')->user()->name }}</a>
                                            <a href="{{ route('customer.logout') }}" style="line-height: 18px;">{{ __('Logout') }}</a>
                                        @else
